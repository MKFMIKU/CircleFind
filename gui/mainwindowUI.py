...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.downButton.setMaximumSize(QtCore.QSize(50, 50))
        ...
        self.cardButton = QtWidgets.QPushButton(self.centralWidget)
        self.cardButton.setMinimumSize(QtCore.QSize(50, 50))
        self.cardButton.setMaximumSize(QtCore.QSize(50, 50))
        self.cardButton.setStyleSheet("border-image: url(:/new/outer/down_black.png)")
        self.cardButton.setText("")
        self.cardButton.setObjectName("cardButton")
        self.verticalLayout_5.addWidget(self.cardButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "卡片"))
